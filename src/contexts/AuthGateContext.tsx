          ...
          <div onClick={e => e.stopPropagation()} className="card-glass"
            ...
            <button onClick={() => setOpen(false)} aria-label="Fermer"
              style={{ position: 'absolute', top: 12, right: 12, background: 'transparent', border: 'none',
                color: '#8a7a9a', cursor: 'pointer', display: 'flex' }}>
              <X size={18} />
            </button>
            ...
            <h3 className="font-display" style={{ fontSize: 20, fontWeight: 700, color: '#f0e6d3', margin: 0 }}>
              Créez un compte pour continuer
            </h3>
            <p style={{ fontSize: 13.5, color: '#b8a898', lineHeight: 1.6, margin: '8px 0 20px' }}>
              {intent
                ? <>Pour <b style={{ color: '#e8c97a' }}>{intent}</b>, connectez-vous ou inscrivez-vous — c'est gratuit et rapide.</>
